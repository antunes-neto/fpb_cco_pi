...
def salvarImg():
    global imagemEmCache
    files = [("Arquivo TIFF","*.tiff"),("Arquivo PNG","*.png"),("Arquivo GIF","*.gif")]
...
window.resizable(False,False) #comenta aqui em caso de algum problema de a imagem estar muito pequena
